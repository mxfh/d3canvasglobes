...
Number.prototype.cycle = function(n, increment) {
  if (increment === undefined) {increment = 1; }
  return (this + increment + n) % n;
};
...
// color list from
// http://stackoverflow.com/q/1573053/731179
//  with added gray/gray
